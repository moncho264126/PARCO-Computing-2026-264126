 ...
 *               - OpenMP parallelization with auto scheduling and tunable threads
 ...
 *
 * Compilation:
 *        gcc -O3 -march=native -o par_auto_imp_spmv par_auto_imp_spmv.c mmio.c -lm -fopenmp
 *
 * Execution:
 *        ./par_auto_imp_spmv matrix.mtx vector.mtx <threads>
 *
 * Output:
