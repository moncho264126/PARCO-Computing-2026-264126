 ...
 *               - OpenMP parallelization with runtime scheduling and tunable chunk size and threads
 ...
 *
 * Compilation:
 *        gcc -O3 -march=native -o par_runtime_imp_spmv par_runtime_imp_spmv.c mmio.c -lm -fopenmp
 *
 * Execution:
 *        ./par_runtime_imp_spmv matrix.mtx vector.mtx
 *
 * Output:
