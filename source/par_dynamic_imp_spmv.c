 ...
 *               - OpenMP parallelization with dynamic scheduling and tunable chunk size and threads
 ...
 *
 * Compilation:
 *        gcc -O3 -march=native -o par_dynamic_imp_spmv par_dynamic_imp_spmv.c mmio.c -lm -fopenmp
 *
 * Execution:
 *        ./par_dynamic_imp_spmv matrix.mtx vector.mtx <threads> <chunk_size>
 *
 * Output:
