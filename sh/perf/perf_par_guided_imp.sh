 ...
 *    executable `par_guided_imp_spmv`.
 *
 *    This script:
 *        1. Compiles the source code (`par_guided_imp_spmv.c` and `mmio.c`) with OpenMP support.
...
SOURCE="$SOURCE_DIR/par_guided_imp_spmv.c"
MMIO="$SOURCE_DIR/mmio.c"
EXE_NAME="par_guided_imp_spmv"
...
for idx in "${SELECTED_INDICES[@]}"; do
    ...
    for THREAD in "${THREADS[@]}"; do
        for CHUNK in "${CHUNKSIZES[@]}"; do
            ...
            RESULT_FILE="$RESULTS_DIR/par_guided_imp_${THREAD}_${CHUNK}_${PCT}.txt"
